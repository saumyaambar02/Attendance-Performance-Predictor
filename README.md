...
Visual charts for attendance percentage 
Predict which students might be at risk of failing (based on attendance + marks) 
Clean menu system so users can choose options easily 
...
5. Use the menu options to add students, mark attendance, add marks, etc. 
